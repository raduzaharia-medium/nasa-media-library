  ...
  return (
    <form className="search" onSubmit={(e) => doSearch(e)}>
      ...
      <p>
        ...
        <input type="number" className="from" placeholder="year" min="1900" max="9999" value={startYear} onChange={(e) => setStartYear(e.target.value)} />
        <label className="optional">and</label>
        <input type="number" className="to" placeholder="year" min="1900" max="9999" value={endYear} onChange={(e) => setEndYear(e.target.value)} />
      </p>
